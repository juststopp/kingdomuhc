...
public class TouJou extends Role {
    ...
    public TouJou() {
        super(
                ...
                Camps.ZHAO,
                new Language("roles.zhao.toujou.short_desc").getAsList(),
                new Language("roles.zhao.toujou.long_desc").getMessage()
        );
    }
    ...
    public void runPassif() {
        ...
        for(Entity entity : this.getPlayer().getNearbyEntities(10, 10, 10)) {
            if(entity instanceof Player) {
                ...
                if(player != null && player.getRole().getCamp() == Camps.ZHAO) {
